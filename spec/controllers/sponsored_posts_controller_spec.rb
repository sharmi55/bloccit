...
RSpec.describe SponsoredPostsController, type: :controller do
  ...
  describe "POST create" do
    ...
    it "increases the number of Sponsored Posts by 1" do
      expect{post :create, topic_id: my_topic.id, sponsored_post: {price: 46, title: RandomData.random_sentence, body: RandomData.random_paragraph}}.to change(SponsoredPost,:count).by(1)
    end
    ...
    it "redirects to the new sponsored post" do
      post :create, topic_id: my_topic.id, sponsored_post: {title: RandomData.random_sentence, body: RandomData.random_paragraph, price: 36}
  ...
  describe "PUT update" do
    it "updates sponsored post with expected attributes" do
      ...
      put :update, topic_id: topic.id, id: sponsored_post.id, post: {title: new_title, body: new_body, price: new_price}
